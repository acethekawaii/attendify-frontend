...
@Component({
  ...
  styleUrl: './attendance-summary-by-member-status.css'
})

export class AttendanceSummaryByMemberStatus {
  ...
  loadAttendanceSummary() {
    ...
    this.reportService.getAttendanceSummary(this.selectedEvent, formattedDate, 'memberStatus').pipe(
